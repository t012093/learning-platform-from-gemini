...
export const VIBE_CHAPTER_5_DATA: DocChapter = {
  id: 'vibe-ch5',
  title: { en: 'Chapter 5 | Vibe Coding with Gemini CLI', jp: '第5章｜Gemini CLIによるバイブコーディング' },
  subtitle: { 
  ...
  sections: [
    {
      id: '5-1',
      title: { en: '5-1. Why CLI? No More Copy-Paste', jp: '5-1. なぜCLIなのか？コピペ地獄からの解放' },
      content: [
        {
          type: 'text',
          text: {
    ...
    {
      id: '5-2',
      title: { en: '5-2. Installation & Setup', jp: '5-2. 導入とセットアップ' },
      content: [
        {
          type: 'text',
          text: {
...
gemini "Create a simple Express server"`
    ...
    {
      id: '5-3',
      title: { en: '5-3. Coding with Natural Language', jp: '5-3. 自然言語でコードを実装する' },
      content: [
        {
          type: 'text',
          text: {
...
> Done.`
    ...
    {
      id: '5-4',
      title: { en: '5-4. Connecting Frontend and Backend', jp: '5-4. フロントとバックを接続する' },
      content: [
        {
          type: 'text',
          text: {
