        ...
        <div className="min-h-screen bg-slate-50 p-8 pb-24">
            ...
            <div className="max-w-7xl mx-auto mb-12">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <h1 className="text-4xl font-bold text-slate-900">AI Partners</h1>
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
                {CHARACTERS.map((char) => (
                    ...
                    >
                        ...
                        <div className="p-8 flex-1 flex flex-col">
                            ...
                            <div className="mb-8">
                                <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3">Specialties</h3>
                            ...
                            <button
                             ...
                             `}
                            >
                                <MessageSquare size={18} /> Chat with {char.botName}
                            </button>
                        </div>
                    </div>
                ))}
                ...
                <div className="bg-slate-50 rounded-3xl border-2 border-dashed border-slate-200 flex flex-col items-center justify-center p-12 text-center opacity-70 hover:opacity-100 transition-opacity">
                    ...
                    <h3 className="font-bold text-slate-500 text-lg">Coming Soon</h3>
                    <p className="text-slate-400 text-sm max-w-xs mx-auto">
                        New AI partners with specialized skills like Security and design are in training.
                    </p>
                </div>
