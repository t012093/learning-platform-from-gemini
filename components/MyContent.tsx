...
import { Sparkles, Play, Share2, DollarSign, Lock, Globe, Wand2, Loader2, Send, Bot, User, Clock, CheckCircle2, Cpu, Image as ImageIcon, Mic } from 'lucide-react';
...
const MyContent: React.FC<MyContentProps> = ({ onNavigate }) => {
                    ...
                    <div key={content.id} className="bg-white rounded-xl border border-slate-200 overflow-hidden hover:shadow-lg transition-all hover:translate-y-[-2px] group duration-300">
                        ...
                        <div className="p-5">
                            ...
                            <div className="grid grid-cols-2 gap-2 mt-3">
                                <button
                                    onClick={() => {
                                        if (onNavigate) onNavigate(ViewState.GENERATED_COURSE_PATH);
                                    }}
