...
export class BattleScene9 extends BattleScene {
  ...
  create() {
    ...
    this.setupStageCommon({
      ...
      delayedMessage: {
        delay: 3000,
        text: '影の獣との戦いです！新しい閃光魔法を習得して戦いましょう！'
      }
    });
    
    this.addLog('👻 影の獣は通常攻撃・既存魔法を全て回避する！');
    this.addLog('⚠️ 普通の魔法では勝てません！新しい魔法が必要です！');
    this.addLog('💡 ヒント: 2回繰り返しブロックで「左右右左左左右左右右左左左右左右右左左左右」(21回の手振り)を作ろう！');
    this.addLog('✨ この長いパターンで「閃光魔法」を習得できます！');
